...
export async function getData(): Promise<{ industries: any[], valves: any[], siteSettings?: any }> {
  ...
  try {
    ...
    if (data) {
      // Defensively merge default images in case they are missing from existing DB state
      const defaultSettings = { companyName: 'Seyon Enterprises', email: 'sales@seyonflo.in', phone: '+91 98847 25066', address: 'S/O Mathialagan, 1/E 388A, 19TH STREET, THAI MOOGAMBIGAI NAGAR, Madambakkam, Kancheepuram, Tamil Nadu, India-603202', homeHeroText: 'High Performance Industrial Valves', homeHeroImage: 'https://4.imimg.com/data4/XP/YO/ANDROID-11872361/product-500x500.jpeg', homeAboutImage: 'https://4.imimg.com/data4/XP/YO/ANDROID-11872361/product-500x500.jpeg', aboutHeroImage: 'https://4.imimg.com/data4/XP/YO/ANDROID-11872361/product-500x500.jpeg', aboutGridImage1: 'https://4.imimg.com/data4/XP/YO/ANDROID-11872361/product-500x500.jpeg', aboutGridImage2: 'https://4.imimg.com/data4/XP/YO/ANDROID-11872361/product-500x500.jpeg', aboutGridImage3: 'https://4.imimg.com/data4/XP/YO/ANDROID-11872361/product-500x500.jpeg', aboutGridImage4: 'https://4.imimg.com/data4/XP/YO/ANDROID-11872361/product-500x500.jpeg' };
